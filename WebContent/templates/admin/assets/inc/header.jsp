        ...
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <%
            	...
            	if(session.getAttribute("adminInfo") != null){
            		admin = (User)session.getAttribute("adminInfo");
			%>
            <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;"> Xin chào, <%=admin.getFull_name()%><b></b> &nbsp; <a href="<%=request.getContextPath()%>/logoutcontroller" class="btn btn-danger square-btn-adjust">Đăng xuất</a> </div>
            <%
            	}
            %>
        </nav>
